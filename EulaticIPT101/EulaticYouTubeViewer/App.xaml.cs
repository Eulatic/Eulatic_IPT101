...
using EulaticSolution.EulaticDomain.Commands;
using EulaticSolution.EulaticDomain.Queries;
using EulaticSolution.EulaticFramework;
using EulaticSolution.EulaticFramework.Commands;
using EulaticSolution.EulaticFramework.Queries;
using EulaticSolution.EulaticYouTubeViewer.Stores;
using EulaticSolution.EulaticYouTubeViewer.ViewModels;
using EulaticSolution.EulaticYouTubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace EulaticSolution.EulaticYouTubeViewer
{
    /// <summary>
